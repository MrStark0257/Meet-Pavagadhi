        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-8 my-auto">
          ...
          <div className="lg:col-span-4 flex justify-center perspective-[1400px] relative my-8 lg:my-0">
            ...
            <div className="absolute -top-12 left-1/2 -translate-x-1/2 flex flex-col items-center pointer-events-none z-20">
              ...
              <div className="w-[2px] h-10 bg-gradient-to-b from-cyan-400 via-blue-500 to-transparent"></div>
            </div>

            {/* Spinning Arc Reactor Background Halo Ring */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[340px] md:w-[420px] h-[340px] md:h-[420px] rounded-full border border-blue-500/25 border-dashed animate-spin pointer-events-none z-0" style={{ animationDuration: '28s' }}></div>
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[280px] md:w-[340px] h-[280px] md:h-[340px] rounded-full border border-cyan-400/30 blur-sm pointer-events-none z-0 animate-pulse"></div>
            ...
            >
              ...
              <div className="absolute -top-3 -right-6 md:-right-8 z-40 px-3.5 py-1.5 bg-[#091122]/95 backdrop-blur-2xl border border-blue-500/60 rounded-2xl shadow-[0_10px_30px_rgba(59,130,246,0.3)] flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-cyan-400 animate-ping"></span>
                <span className="text-[10px] font-mono font-bold text-cyan-300 uppercase tracking-widest">STARK OS v8.5</span>
              </div>

              {/* Floating Widget 3: Bottom-Right Spec Badge */}
              <div className="absolute -bottom-3 -right-6 md:-right-8 z-40 px-4 py-2 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-2xl shadow-[0_10px_30px_rgba(0,240,255,0.4)] flex items-center gap-2 text-white font-mono text-[10px] font-bold tracking-widest uppercase">
                <span>ARC CORE</span>
                <span>⚡ 100%</span>
              </div>
              ...
              <div className="relative w-[280px] sm:w-[310px] md:w-[340px] p-3.5 bg-[#070d1d]/95 backdrop-blur-3xl rounded-[2.4rem] border border-blue-500/40 shadow-[0_30px_90px_rgba(0,0,0,0.95)] overflow-hidden group-hover:border-cyan-400/90 transition-all duration-500">
                ...
                <div className="absolute bottom-6 inset-x-6 z-30 px-4 py-2 bg-black/85 backdrop-blur-xl border border-cyan-400/40 rounded-xl text-[10px] font-mono text-white flex items-center justify-between shadow-2xl">
