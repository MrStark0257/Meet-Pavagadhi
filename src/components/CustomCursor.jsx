  ...
  return (
    <>
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(circle, rgba(59,130,246,0.25) 0%, rgba(6,182,212,0.08) 45%, transparent 75%)'
        }}
      ></div>
      ...
      <div
        ref={dotRef}
        className="fixed top-0 left-0 z-[9999] pointer-events-none w-3 h-3 bg-blue-500 rounded-full shadow-[0_0_15px_#3B82F6]"
      ></div>

      {/* Global Custom Cursor Ring */}
      <div
        ref={ringRef}
        className="fixed top-0 left-0 z-[9999] pointer-events-none w-12 h-12 border border-cyan-400/60 rounded-full flex items-center justify-center backdrop-blur-[1px]"
      ></div>
    </>
  );
};
